...
Name it Virtual Machine, Disk capacity being 20 GB and give more memory of 2GB
...
Next is mount the data partitions. The directory is already made
	...
	cd /mnt  in the mnt folder make the disk
...
Get rid of the hashtags of those two. It Should look like this
